 ...
 <div class="content-wrapper">
   ...
   <section class="content-header">
     ...
     <ol class="breadcrumb">
       ...
       <li class="active">Administrar Im&aacute;genes</li>
     </ol>
   </section>
   ...
   <section class="content">
     ...
     <div class="box">
       ...
       <div class="box-body">
					<form role="form" action="eliminarimg.php?id=1" method="post">
             ...
             <th style="text-align:center;padding:8px">Selecci&oacute;n
						...
						<?php
									$sql = mysqli_query($conn, "SELECT * FROM imagenes");
								...
								<tbody>
									...
									<td align="center">
									<?php echo "<a href='../$arreglo[1]' data-title='' data-footer='' data-toggle=lightbox data-type=image><button type='button' class='btn btn-info'>Vista</button></a>";?>
									</td>
									<td align="center">
										<?php
										echo "<input type='checkbox' class='minimal check' name='seleccion[]' value='".$arreglo[0]."'>";
										?>
									</td>
								</tbody>
								<?php
