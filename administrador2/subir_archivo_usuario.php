...
if (isset($filesUploaded) and !empty($filesUploaded)) {
    ...
    {
         $query1=mysql_query("SELECT*from img_user where img='$singleFile'");
          $sql=mysql_num_rows($query1);
          if ($sql>0)
          {
  ...
  if (isset($filesUploaded) and !empty($filesUploaded)) {
      ...
      {
          require ("conectardb.php");
          $query1=mysql_query("SELECT * from vid_user where vid='$singleFile'");
          $sql=mysql_num_rows($query1);
          if ($sql>0)
          {
            echo ' <script language="javascript">alert("Atencion, ya existe el video.");</script> ';
          } else {
            mysql_query("INSERT INTO vid_user VALUES('','$singleFile','$user')");
            echo '<script language="javascript">alert("El archivo fue cargado exitosamente.");</script>';
          }
      }
  ...
  if (isset($filesUploaded) and !empty($filesUploaded)) {
      ...
      {
          require ("conectardb.php");
          $query1=mysql_query("SELECT * from text_user where texto='$singleFile'");
          $sql=mysql_num_rows($query1);
          if ($sql>0)
          {
            echo ' <script language="javascript">alert("Atencion, ya existe el archivo.");</script> ';
          } else {
            mysql_query("INSERT INTO text_user VALUES('','$singleFile','$user')");
            echo '<script language="javascript">alert("El archivo fue cargado exitosamente.");</script>';
          }
      }
